namespace RemoteMonitor
{
    partial class FrmMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ToolBar.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {this.toolStripSeparator1, this.tbLayout, this.btnMonitorConfig, this.tbBedManage, this.DropDownAlarm, this.btnSystemConfig, this.btnSystemConfig1, this.tbHistory, this.toolStripSeparator3, this.tbAbout, this.tbAlarmOn});
            ...
            this.DropDownAlarm.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {this.btnAlarmPara, this.btnQuery});
            ...
            this.btnSystemConfig.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {this.btnSystemSet, this.btnDemo});
