    ...
    public static class Informations
    {
        ...
        public static SensorType MapVitalSignSenorCodeToSensorType(byte code)
        {
            switch (code)
            {
                ...
                case 0x4d:
                    return SensorType.ArtBloodPressure;
                case 0x56:
                    return SensorType.EcgLeadI;
                case 0x57:
                    return SensorType.EcgLeadII;
        ...
        public static IList<VitalSignType> VitalSignTypesForSensor(SensorType sensorType)
        {
            switch (sensorType)
            {
                ...
                case SensorType.ArtBloodPressure:
                    return new List<VitalSignType>
                    {
                        VitalSignType.ArtMeanArterialPressure,
                        VitalSignType.ArtSystolicBloodPressure, 
                        VitalSignType.ArtDiastolicBloodPressure
                    };
                case SensorType.SpO2:
                    return new[] {VitalSignType.SpO2, VitalSignType.SHeartRate};
